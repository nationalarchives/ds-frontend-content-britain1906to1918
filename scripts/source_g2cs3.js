...
function lcLoadMenus() {
  ...
  lc_menu_0.addMenuItem("source&nbsp;1","location='g2cs3s1a.htm'");
  lc_menu_0.addMenuItem("source&nbsp;2","location='g2cs3s2.htm'");
  lc_menu_0.addMenuItem("source&nbsp;3","location='g2cs3s3.htm'");
  lc_menu_0.addMenuItem("source&nbsp;4","location='g2cs3s4a.htm'");
  lc_menu_0.addMenuItem("source&nbsp;5","location='g2cs3s5.htm'");
