...
function lcLoadMenus() {
  ...
  lc_menu_0.addMenuItem("source&nbsp;2","location='g1cs2s2.htm'");
  lc_menu_0.addMenuItem("source&nbsp;3","location='g1cs2s3.htm'");
  lc_menu_0.addMenuItem("source&nbsp;4","location='g1cs2s4a.htm'");
  lc_menu_0.addMenuItem("source&nbsp;5","location='g1cs2s5a.htm'");
