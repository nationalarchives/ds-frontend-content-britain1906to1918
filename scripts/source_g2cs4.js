...
function lcLoadMenus() {
  ...
  lc_menu_0.addMenuItem("source&nbsp;3","location='g2cs4s3a.htm'");
  lc_menu_0.addMenuItem("source&nbsp;4","location='g2cs4s4a.htm'");
  lc_menu_0.addMenuItem("source&nbsp;5","location='g2cs4s5.htm'");
  lc_menu_0.addMenuItem("source&nbsp;6","location='g2cs4s6.htm'");
  lc_menu_0.addMenuItem("source&nbsp;7","location='g2cs4s7.htm'");
  lc_menu_0.addMenuItem("source&nbsp;8","location='g2cs4s8.htm'");
