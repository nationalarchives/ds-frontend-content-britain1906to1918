...
function lcLoadMenus() {
  ...
  lc_menu_0.addMenuItem("source&nbsp;1","location='g5cs3s1.htm'");
  lc_menu_0.addMenuItem("source&nbsp;2","location='g5cs3s2.htm'");
  lc_menu_0.addMenuItem("source&nbsp;3","location='g5cs3s3.htm'");
  lc_menu_0.addMenuItem("source&nbsp;4","location='g5cs3s4.htm'");
  lc_menu_0.addMenuItem("source&nbsp;5","location='g5cs3s5.htm'");
  lc_menu_0.addMenuItem("source&nbsp;6","location='g5cs3s6.htm'");
  lc_menu_0.addMenuItem("source&nbsp;7","location='g5cs3s7.htm'");
  lc_menu_0.addMenuItem("source&nbsp;8","location='g5cs3s8.htm'");
