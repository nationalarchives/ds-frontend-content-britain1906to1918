...
function lcLoadMenus() {
  ...
  lc_menu_0.addMenuItem("source&nbsp;1","location='g3cs2s1.htm'");
  lc_menu_0.addMenuItem("source&nbsp;2","location='g3cs2s2.htm'");
  lc_menu_0.addMenuItem("source&nbsp;3","location='g3cs2s3.htm'");
  lc_menu_0.addMenuItem("source&nbsp;4","location='g3cs2s4.htm'");
  lc_menu_0.addMenuItem("source&nbsp;5","location='g3cs2s5a.htm'");
  lc_menu_0.addMenuItem("source&nbsp;6","location='g3cs2s6a.htm'");
  lc_menu_0.addMenuItem("source&nbsp;7","location='g3cs2s7a.htm'");
