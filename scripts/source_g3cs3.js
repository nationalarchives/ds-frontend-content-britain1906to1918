...
function lcLoadMenus() {
  ...
  lc_menu_0.addMenuItem("source&nbsp;2","location='g3cs3s2a.htm'");
  lc_menu_0.addMenuItem("source&nbsp;3","location='g3cs3s3.htm'");
  lc_menu_0.addMenuItem("source&nbsp;4","location='g3cs3s4.htm'");
  lc_menu_0.addMenuItem("source&nbsp;5","location='g3cs3s5.htm'");
  lc_menu_0.addMenuItem("source&nbsp;6","location='g3cs3s6.htm'");
