...
function lcLoadMenus() {
  ...
  lc_menu_0.addMenuItem("source&nbsp;1","location='g5cs2s1a.htm'");
  lc_menu_0.addMenuItem("source&nbsp;2","location='g5cs2s2.htm'");
  lc_menu_0.addMenuItem("source&nbsp;3","location='g5cs2s3a.htm'");
  lc_menu_0.addMenuItem("source&nbsp;4","location='g5cs2s4.htm'");
  lc_menu_0.addMenuItem("source&nbsp;5","location='g5cs2s5.htm'");
  lc_menu_0.addMenuItem("source&nbsp;6","location='g5cs2s6.htm'");
  lc_menu_0.addMenuItem("source&nbsp;7","location='g5cs2s7.htm'");
  lc_menu_0.addMenuItem("source&nbsp;8","location='g5cs2s8.htm'");
  lc_menu_0.addMenuItem("source&nbsp;9","location='g5cs2s9.htm'");
