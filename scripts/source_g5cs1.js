...
function lcLoadMenus() {
  ...
  lc_menu_0.addMenuItem("source&nbsp;3","location='g5cs1s3.htm'");
  lc_menu_0.addMenuItem("source&nbsp;4","location='g5cs1s4.htm'");
  lc_menu_0.addMenuItem("source&nbsp;5","location='g5cs1s5.htm'");
  lc_menu_0.addMenuItem("source&nbsp;6","location='g5cs1s6.htm'");
  lc_menu_0.addMenuItem("source&nbsp;7","location='g5cs1s7.htm'");
